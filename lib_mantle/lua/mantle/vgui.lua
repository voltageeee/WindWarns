...
function Mantle.ui.frame(s, title, width, height, close_bool, anim_bool)
    ...
    if close_bool then
        ...
        s.cls.DoRightClick = function()
            ...
            DM:AddOption('Close окно', function()
                s:Remove()
...
function Mantle.ui.player_selector(doclick, func_check)
    ...
    Mantle.ui.frame(Mantle.ui.menu_player_selector, 'Player selection', 250, 400, false, true)
    ...
    for i, pl in pairs(player.GetAll()) do
        ...
        panel_ply.Paint = function(self, w, h)
            ...
            if IsValid(pl) then
                ...
                draw.SimpleText('Disconnected', 'Fated.18', w * 0.5, h * 0.5, color_red, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            end
        end
    ...
    Mantle.ui.menu_player_selector.btn_close:SetText('Close')
...
function Mantle.ui.color_picker(func, color_standart)
    ...
    Mantle.ui.menu_color_picker.btn_close:SetText('Close')
